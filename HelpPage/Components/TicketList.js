...
import { 
    fetchSupportTicketsByCustomerEmail,
    saveSupportTicket,
...
const TicketList = (props) => {
    ...
    const initPageData = async () => {
        setIsLoading(true);
        const _res = await fetchSupportTicketsByCustomerEmail(userDetails?.email, pageFilters, setTotalItems, pagiCurrentPage, PAGI_LIMIT);

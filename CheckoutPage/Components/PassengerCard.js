...
const PassengerCard = (props) => {
    ...
    const { given_name, family_name, id, infant_passenger_id, born_on } = passenger;
    ...
    return (
        <div className="checkout_passenger_card" style={{position: "relative", border: "1px dashed rgba(0,0,0,0.2)", width: "calc(50% - 5px)", borderRadius: 8, marginTop: 7}}>
            {
                removeCustomer &&
                <p onClick={removeCustomer}
                    style={{position: "absolute", bottom: 0, left: 0, zIndex: 3, color: "crimson", background: "white", cursor: "pointer", padding: "8px 10px"}}>
            ...
            <div onClick={()=>props.selectPassengerCard(props.index)} style={{cursor: "pointer", padding: 10, backgroundColor: "rgba(0,0,0,0.07)"}}>
                ...
                <p style={{padding: 10, textAlign: "center", 
                    ...
                    fontFamily: "'Prompt', Sans-serif", fontSize: 12, marginTop: 10}}>
